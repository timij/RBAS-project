...
input_up_p		= (keyboard_check_pressed(global.key_up)||keyboard_check_pressed(vk_up));
input_down_p	= (keyboard_check_pressed(global.key_down)||keyboard_check_pressed(vk_down));
input_enter_p	= (keyboard_check_pressed(global.key_enter)||keyboard_check_pressed(vk_enter));
input_revert_p	= (keyboard_check_pressed(global.key_revert)||keyboard_check_pressed(vk_backspace));
